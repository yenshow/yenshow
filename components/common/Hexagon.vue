<template>
	<div class="hexagon h-[108px] md:h-[128px] lg:h-[160px] xl:h-[192px] 2xl:h-[224px] -rotate-90 lg:rotate-0">
		<nuxt-img
			:src="imageSrc"
			:alt="`${title} 圖示`"
		...
		/>
		<span class="hexagon-content text-[12px] md:text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[28px]">{{ title }}</span>
	</div>
</template>
